...
public partial class StoreSampleContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-KP5PRS9;Initial Catalog=StoreSample;User ID=sa;Password=adminsa;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<SalesDatePrediction>()
            .ToSqlQuery("EXEC [dbo].[SalesDatePrediction]").HasNoKey();
